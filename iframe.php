...
function setResponse(val) {
	...
	<div style="background-color:#ffffff; border:1px solid #aaaaaa; border-bottom:none; width:100%;">			
<p style="width:100%; padding:10px; color:#fff; margin-top:0px;  background-color:#333;">
	Voice help desk</p><div id="response" style="padding:20px;padding-top:5px;  height:170px; width:100%;  overflow:auto;"></div>	
	</div>
<input size="26" style="width:100%; border-top: 1px solid #575757;" id="input" type="text"> <button id="rec">Speak</button>
</div>
